    ...
    return (
        <Container id="home">
            <Row className="justify-content-center align-items-center">
                <Col sm={12} md={6} lg={6} className="" data-aos="fade-right">
                ...
                <Col sm={12} md={6} lg={6} ><img data-aos="fade-left" className="w-100" src="https://i.ibb.co/yWGMkCh/Programmer-cuate.png" alt="" /></Col>
            </Row>
        </Container >
    );
};
